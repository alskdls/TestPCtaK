...
![Інформація з html файлу](/Coverage_report.png))
...
# Висновок:
    ...
    - У ході виконання роботи було розглянуто основи тестування Python-коду. Реалізовано перевірки з використанням assert, створено класи з валідацією вхідних даних, написано юніт-тести за допомогою бібліотек unittest та pytest. Також було перевірено покриття коду тестами з використанням coverage та pytest-cov, згенеровано HTML-звіт покриття.
    ❓ Чи досягнуто мети роботи:
    - Так, мету роботи досягнуто повністю. Було отримано практичні навички написання та запуску юніт-тестів, а також аналізу покриття коду тестами.
    ❓ Які нові знання отримано:
    - Під час виконання роботи було отримано практичні знання щодо використання оператора assert для перевірки коректності даних, реалізації валідації аргументів у класах, створення та запуску юніт-тестів за допомогою бібліотек unittest і pytest, а також аналізу покриття коду тестами з використанням інструментів coverage та pytest-cov.
    ❓ Чи вдалось відповісти на всі питання задані в ході роботи:
    - Так, усі питання були розібрані та опрацьовані.
